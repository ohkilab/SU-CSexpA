...
初版レポート提出後である第一部のDay4並びに第二部のDay9では，各自のレポートのピアレビューを行います．そのための準備として，テンプレートのレポートピアレビューのページをグループの人数分コピーして追加しておいてください（ピアレビューを行う人数がわからない場合は，4人分のページを作成しておいてください）．最終的には以下のような構成になります．
