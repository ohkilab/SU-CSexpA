...
- Day5 「HTTPベンチマークプログラムの機能拡張」について1つの機能を選択して実装する
...
- Day5 「HTTPベンチマークプログラムの機能拡張」について2つ以上の機能を実装する
...
### HTTPベンチマークプログラムの機能拡張，およびHTTPサーバ機能拡張

いずれにおいても，必須課題として，最低限1つの機能拡張を行うことを条件としています．
