...
各自で動作を確認してほしいので，xxxxx という部分はあなたの好きな10000から65535までの番号を記述してください．何故5桁なのか知りたい方はWell known portで調べてみてください．
...
-   Webブラウザで`http://192.168.1.101:xxxxx`と入力してEnterしてみてください．「It Works!」とWebブラウザ上に表示されたら成功です．
